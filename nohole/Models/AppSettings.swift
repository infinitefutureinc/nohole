...
final class AppSettings {
    ...
    var gaussianBlurRadius: Double {
        didSet { UserDefaults.standard.set(gaussianBlurRadius, forKey: "gaussianBlurRadius") }
    }
    ...
    init() {
        ...
        self.gaussianBlurRadius = defaults.object(forKey: "gaussianBlurRadius") as? Double ?? 54.0
